package by.demid.CRUD.controller;
...
public class UserController {
    ...
    public ModelAndView editUser(@RequestParam long id, @ModelAttribute User user) {
        ...
        return new ModelAndView("userForm", "oserObject", user);
    }
    ...
    public ModelAndView saveUser(@ModelAttribute User user) {
        ...
        return new ModelAndView("redirect:getAllUser");
    }
    ...
    public ModelAndView getAllUser(@RequestParam(required = false) Integer page) {
        logger.info("Getting the  User gage" + page);
