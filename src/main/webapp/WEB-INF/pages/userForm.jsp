...
<meta name="author" content="Demid Reddy">
<head>
  ...
  <div class="panel panel-success">
    ...
    <div class="panel-body">
      <form:form id="userRegisterForm" cssClass="form-horizontal" modelAttribute="user" method="post" action="saveUser">
        ...
        <div class="form-group">
            <form:label path="tadmin" cssClass="control-label col-xs-3">Admin 1 or 0</form:label>
            <div class="col-xs-6">
                <form:input cssClass="form-control" path="tadmin" value="${userObject.tadmin}"/>
          </div>
        </div>
